...
document.addEventListener("DOMContentLoaded",()=>{
 ...
 document.querySelectorAll("form[data-demo]").forEach(form=>form.addEventListener("submit",e=>{
   e.preventDefault(); const notice=form.querySelector(".notice"); if(notice){notice.textContent="Thank you. Your request has been received. A BREALTY GHANA representative will contact you shortly.";notice.classList.add("show")} form.reset();
 }));
});
